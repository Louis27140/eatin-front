          ...
          <v-stepper-items>
            ...
            <v-stepper-content step="2">
              <v-form ref="profileForm" v-model="profileValid" lazy-validation>
                <v-form-base :model="infos" :schema="profileSchema" />
              </v-form>
              <v-btn class="white--text" color="grey" @click="step = 1" rounded>
                Précédent
              </v-btn>
              <v-btn
                :loading="loader"
    ...
    return {
      ...
      authSchema: {
        ...
        email: {
          type: "email",
          label: "Email",
          rules: [formHelpers.mandatory, formHelpers.regexMail],
          col: 12,
        ...
        password: {
          type: "password",
          label: "Mot  de passe",
          rules: [formHelpers.mandatory, formHelpers.regexPassword],
          col: 12,
        ...
        passwordConfirmation: {
          ...
          rules: [
            ...
            (v) =>
              this.infos.password == this.infos.passwordConfirmation ||
